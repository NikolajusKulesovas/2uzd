...
<html lang="en"><head>
    ...
    <div class="banner">
        <header class="maxWidthWrapper">
            ...
            <ul class="navigation">
                <li><a href="drivers-teams" class="aktualu">PILOTAI IR KOMANDOS</a></li>
            ...
            <div class="maxWidthWrapper">
                ...
                <div style="display:flex;  flex-direction: row">
                        <div class="main-wrapper-2 ">
                           ...
                           <div class="driverteamGrid ">
                                <div class="driverteambox" style="border: solid 2px #6CAEA9;">
                                    <a href="#" class="driverteamheader hovereffect mercedesback  ">
                                        <div class="driverTeamIcon mercedesback">
                                                <img src="Images/Constructors/MercedesIcon.jpg" class="teamImage2" alt="Mercedes Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Hamilton.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Russell.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #FE0100;">
                                    <a href="#" class="driverteamheader hovereffect ferrariback  ">
                                        <div class="driverTeamIcon ferrariback">
                                                <img src="Images/Constructors/FerrariIcon.jpg" class="teamImage2" alt="Ferrari Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Leclerc.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Sainz.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #15185E;">
                                    <a href="#" class="driverteamheader hovereffect redbullback  ">
                                        <div class="driverTeamIcon redbullback">
                                                <img src="Images/Constructors/RedBullIcon.jpg" class="teamImage2" alt="Red Bull Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Verstappen.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Perez.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #FF8700;">
                                    <a href="#" class="driverteamheader hovereffect mclarenback  ">
                                        <div class="driverTeamIcon mclarenback">
                                                <img src="Images/Constructors/MclarenIcon.jpg" class="teamImage2" alt="Mclaren Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Ricciardo.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Norris.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #0F1D2B;">
                                    <a href="#" class="driverteamheader hovereffect alpineback">
                                        <div class="driverTeamIcon alpineback">
                                                <img src="Images/Constructors/AlpineIcon.jpg" class="teamImage2" alt="Alpine Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Alonso.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Ocon.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #02574F;">
                                    <a href="#" class="driverteamheader hovereffect astonmartinback  ">
                                        <div class="driverTeamIcon astonmartinback">
                                                <img src="Images/Constructors/AstonMartinIcon.jpg" class="teamImage2" alt="Aston Martin Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Vettel.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Stroll.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #272850;">
                                    <a href="#" class="driverteamheader hovereffect alphatauriback  ">
                                        <div class="driverTeamIcon alphatauriback">
                                                <img src="Images/Constructors/AlphaTauriIcon.jpg" class="teamImage2" alt="Alpha Tauri Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Gasly.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Tsunoda.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #9A0000;">
                                    <a href="#" class="driverteamheader hovereffect alfaromeoback  ">
                                        <div class="driverTeamIcon alfaromeoback">
                                                <img src="Images/Constructors/AlfaRomeoIcon.jpg" class="teamImage2" alt="Alfa Romeo Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Bottas.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Zhou.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #00A0DF;">
                                    <a href="#" class="driverteamheader hovereffect williamsback  ">
                                        <div class="driverTeamIcon williamsback">
                                                <img src="Images/Constructors/WilliamsIcon.jpg" class="teamImage2" alt="Williams Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Albon.png" class="driverteamimage ">
                                            </a>
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Latifi.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="driverteambox" style="border: solid 2px #EE193B;">
                                    <a href="#" class="driverteamheader hovereffect haasback  ">
                                        <div class="driverTeamIcon haasback">
                                                <img src="Images/Constructors/HaasIcon.jpg" class="teamImage2" alt="Haas Formula 1 Logo">
                                        </div>
                                    </a>
                                    <div class="driverteammain ">
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Magnussen.png" class="driverteamimage ">
                                            </a> 
                                        </div>
                                        <div class="driverteamimagewrapper hovereffect">
                                            <a href="#" style="position:relative">
                                                <img src="https://res.cloudinary.com/f1-fantasy/image/upload/c_scale,f_auto,w_250/v1616743179/Headshots/Schumacher.png" class="driverteamimage">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <footer class="site-footer">
                <div class="footer-container" id="mob-footer">
                    ...
                    <div class="footer-2019">FORMULA 1 © 2022</div>
                </div>
            </footer>
            </footer>
